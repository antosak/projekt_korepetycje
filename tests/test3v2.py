...
for k in barriers:
    ...
    if barriers == [1800, 3600]:
        data_frame.to_excel('../Dat/RawData_prob4590.xlsx', header=True)
    else:
        data_frame.to_excel('../Dat/RawData_prob00.xlsx', header=True)
