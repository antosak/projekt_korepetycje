...
# Basically iterates over algorithm "repeat ="(1000) times for "popsize =..." - population size.
...
for k in popsize:
    ...
    if popsize == 50:
        data_frame.to_excel('../Dat/RawData_popsize_2_50.xlsx', header=True)
    elif popsize == 75:
        data_frame.to_excel('../Dat/RawData_popsize_2_75.xlsx', header=True)
    elif popsize == 100:
        data_frame.to_excel('../Dat/RawData_popsize_2_100.xlsx', header=True)
    else:
        data_frame.to_excel('../Dat/RawData_popsize_2_25.xlsx', header=True)
